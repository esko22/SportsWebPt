define('config.lookups', ['ko', 'jquery', 'knockback','model.filter.collection', 'model.equipment.collection', 'config'],
    function (ko, $, kb, FilterCollection, EquipmentCollection, config) {
        ...
        var signFilterCollection = new FilterCollection(),
            ...
            functionPlanCategories = ko.observableArray(['Rehabilitation', 'Stretching', 'Preventative', 'Spinal Stabilization', 'Strengthening', 'Self Massage', 'Range Of Motion', 'Balance', 'Mobilization']),
            functionExerciseCategories = ko.observableArray(['Stretching', 'Spinal Stabilization', 'Strengthening', 'Self Massage', 'Range Of Motion', 'Balance', 'Mobilization']),
