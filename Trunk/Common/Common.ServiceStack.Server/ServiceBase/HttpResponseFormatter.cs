...
namespace SportsWebPt.Common.ServiceStack
{
    public static class HttpResponseFormatter
    {
        ...
        /// <returns></returns>
        public static HttpResult Ok(object dto = null, string contentType = null)
        {
        ...
        /// <returns></returns>
        public static HttpResult Ok(Stream responseStream, string contentType)
        {
        ...
        /// <returns></returns>
        public static HttpResult Created(object dto = null, string contentType = null)
        {
        ...
        /// <returns></returns>
        public static HttpResult Redirect(string uri)
        {
        ...
        /// <returns></returns>
        public static HttpError BadRequest(string message, Exception exception = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static HttpError UnAuthorized(string errorCode, string errorMessage, IEnumerable<Notification> notifications = null, Exception exception = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static HttpError Forbidden(string errorMessage = null, IEnumerable<Notification> notifications = null, Exception exception = null)
        {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public static HttpError Conflict(string message, IEnumerable<Notification> notifications = null)
        {
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public static HttpError TooLarge(string message, IEnumerable<Notification> notifications = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static HttpError InternalServerError(string errorMessage = null, Exception exception = null)
        {
            return BuildHttpError(HttpStatusCode.InternalServerError, errorMessage ?? ServiceStackResources.Error500, exception: exception);
        }


        private static HttpError BuildHttpError(System.Net.HttpStatusCode statusCode, string message, string errorCode = null, string contentType = null, Exception exception = null, IEnumerable<Notification> notifications = null)
        {
        ...
        private static HttpResult BuildHttpResult(HttpStatusCode statusCode, Stream responseStream, string contentType, Dictionary<string, string> headers = null)
        {
        ...
        private static HttpResult BuildHttpResult(HttpStatusCode statusCode, object dto = null, string contentType = null, Dictionary<string, string> headers = null)
        {
