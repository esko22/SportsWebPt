...
namespace SportsWebPt.Common.ServiceStack
{
      ...
      : IServiceStackHttpHandler, IHttpHandler
    {
        public void ProcessRequest(IHttpRequest request, IHttpResponse response, string operationName)
        {
            ...
            {
                // TODO (maxm): unfortunately this is not working for the root path as servicestack reserves that for the meta redirect.
            ...
            {
                var dto = new ErrorResponse(ServiceStackResources.Error404, null);
