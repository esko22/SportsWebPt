...
namespace SportsWebPt.Common.ServiceStack
{
    ...
    [DataContract]
    public class ApiListResponse<CompactResourceType, SortFieldEnumType> : ApiResponse<ResourceList<CompactResourceType, SortFieldEnumType>> where SortFieldEnumType : struct
    {
        private ResourceList<CompactResourceType, SortFieldEnumType> resourceList;

        public ApiListResponse(CompactResourceType[] items, int totalCount, int offset, int limit, SortFieldEnumType? sortBy, SortDirection? sortDir)
        {
        ...
        public ApiListResponse(CompactResourceType[] items, int totalCount, int offset, int limit)
            : this(items, totalCount, offset, limit, null, null)
        {}
