...
namespace SportsWebPt.Common.Utilities
{
    ...
    /// <see cref="CsvDataRecord"/>. Alternatively, <see cref="ReadDataRecordAsStrings"/> returns data as an array of type <see cref="string"/>.
    /// </para>
    /// <para>
    ...
    /// <see cref="IEnumerable&lt;T&gt;"/> instances that iterate over CSV data as instances of <see cref="CsvDataRecord"/> and <see cref="string"/>[]
    /// respectively.
    /// </para>
    /// </remarks>
    /// <threadsafety>
    ...
    public class CsvReader : IDisposable
    {
        ...
        /// </remarks>
        public IEnumerable<CsvDataRecord> DataRecords
        {
            get
            {
                EnsureNotDisposed();
        ...
        public CsvHeaderRecord HeaderRecord
        {
            ...
            set
            {
                ...
                Check.Argument.IsNotTrue(headerRecord != null, TextResources.CsvHeaderRecordAlreadySet);
               Check.Argument.IsNotTrue(parser.PassedFirstRecord, TextResources.CsvAlreadyWroteFirstRecord);

                parser.PassedFirstRecord = true;
                headerRecord = value;
            }
        }
        ...
        public bool PreserveLeadingWhiteSpace
        {
            ...
            {
                EnsureNotDisposed();
                return parser.PreserveLeadingWhiteSpace;
            }
            set
            {
                EnsureNotDisposed();
                parser.PreserveLeadingWhiteSpace = value;
            }
        }
        ...
        public bool PreserveTrailingWhiteSpace
        {
            ...
            {
                EnsureNotDisposed();
                return parser.PreserveTrailingWhiteSpace;
            }
            set
            {
                EnsureNotDisposed();
                parser.PreserveTrailingWhiteSpace = value;
            }
        }
        ...
        public char ValueDelimiter
        {
            ...
            {
                EnsureNotDisposed();
                return parser.ValueDelimiter;
            }
            set
            {
                EnsureNotDisposed();
                parser.ValueDelimiter = value;
            }
        }
        ...
        public char ValueSeparator
        {
            ...
            {
                EnsureNotDisposed();
                return parser.ValueSeparator;
            }
            set
            {
                EnsureNotDisposed();
                parser.ValueSeparator = value;
            }
        }
        ...
        {
            Check.Argument.IsNotNull(csv, "csv");
        ...
        /// </summary>
        /// <remarks>
        /// This method will parse the next record and return it as an instance of <see cref="CsvDataRecord"/>. If the convenience of the <c>DataRecord</c> class is not needed,
        ...
        /// </returns>
        public CsvDataRecord ReadDataRecord()
        {
            EnsureNotDisposed();

            CsvDataRecord retVal = CsvDataRecord.FromParser(headerRecord, parser);
        ...
        /// </summary>
        /// <remarks>
        /// This method may be useful if the convenience of a <see cref="CsvDataRecord"/> instance is not required. Invoking this method instead of
        ...
        public string[] ReadDataRecordAsStrings()
        {
            ...
            string[] retVal = parser.ParseRecord();
        ...
        /// </returns>
        public ICollection<CsvDataRecord> ReadDataRecords()
        {
            EnsureNotDisposed();
            var retVal = new List<CsvDataRecord>();
            CsvDataRecord record;

            while ((record = CsvDataRecord.FromParser(headerRecord, parser)) != null)
            {
                retVal.Add(record);
            }
        ...
        /// </returns>
        public ICollection<CsvDataRecord> ReadDataRecords(int maximumRecords)
        {
            EnsureNotDisposed();
            Check.Argument.IsNotNegative(maximumRecords, "maximumRecords");
            ...
            {
                CsvDataRecord record = CsvDataRecord.FromParser(headerRecord, parser);
        ...
        public ICollection<string[]> ReadDataRecordsAsStrings()
        {
            ...
            while ((record = parser.ParseRecord()) != null)
            {
                retVal.Add(record);
            }
        ...
        public ICollection<string[]> ReadDataRecordsAsStrings(int maximumRecords)
        {
            ...
            while (numRead < maximumRecords)
            {
                string[] record = parser.ParseRecord();
        ...
        /// available via the <see cref="CsvHeaderRecord"/> property on this <c>CsvReader</c>, but also from the <see cref="CsvDataRecord.HeaderRecord"/>
        /// property in each instance of <see cref="CsvDataRecord"/> created by this <c>CsvReader</c>.
        /// </para>
        /// <para>
        ...
        /// </returns>
        public CsvHeaderRecord ReadHeaderRecord()
        {
            if(parser.PassedFirstRecord){
                throw new InvalidOperationException(TextResources.CsvAlreadyWroteFirstRecord);
            }
            

            CsvHeaderRecord tempHeader = CsvHeaderRecord.FromParser(parser);

            if (tempHeader != null)
            {
                //reset this flag since the first record read was simply the header
                parser.PassedFirstRecord = false;
                HeaderRecord = tempHeader;
            }
        ...
        {
            EnsureNotDisposed();
               Check.Argument.IsNotNegative(number, "number");
        ...
        {
            if(disposed){
                throw new ObjectDisposedException("Reader is disposed");
            }
        }
        ...
        private int Fill(DataSet dataSet, string tableName, int maximumRecords, bool useMaximum)
        {
            ...
            Check.Argument.IsNotNull(tableName, "tableName");
            Check.Argument.IsNotNull(headerRecord, "headerRecord");
            if(useMaximum){
                Check.Argument.IsNotNegative(maximumRecords, "maximumRecords");
            }
            ...
            foreach (string column in headerRecord.Values)
            {
            ...
            while (!useMaximum || (num < maximumRecords))
            {
                ...
                if (record != null)
                {
                    if(record.Length > headerRecord.Values.Count){
                        throw new InvalidOperationException(TextResources.CsvTooManyColumnsInRow.FormatWith(record.Length,headerRecord.Values.Count));
                    }

                    var recordAsStrings = new string[record.Length];
