...
namespace SportsWebPt.Common.DataAccess.Ef
{
    ...
    {
        protected virtual IDictionary<Type, Func<DbContext, object>> GetNonStandardRespositories()
        {
        ...
        {
            _repositoryFactories = GetNonStandardRespositories();
        }
        ...
        /// </remarks>
        protected RepositoryFactory(IDictionary<Type, Func<DbContext, object>> factories)
        {
